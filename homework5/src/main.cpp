...
int main() {
    ...
    */
    // Pink room
    filesystem::path inputDirRoom("examples/pink-room/input");
    filesystem::path outputDirRoom("examples/pink-room/output");
    int frameNumRoom = 80;
    

    Denoise(inputDirRoom, outputDirRoom, frameNumRoom);
